...
/**
 * Retorna 0 se foi possível realizar a inserção de todos os elementos
 * Retorna 2 se não foi possível inserir todos os elementos
*/
template <typename T>
int StaticStack<T>::push(StaticStack<T> s)
{
    if (s.isEmpty())
    {
        return 2;
